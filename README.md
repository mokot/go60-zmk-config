...
| ----------------------------------------- | ----------------------------------------- |
| ![0. HRM Linux](./static/0_HRM_Linux.png) | ![1. HRM MacOS](./static/1_HRM_MacOS.png) |

| 2. Typing                          | 3. AutoShift                              |
| ---------------------------------- | ----------------------------------------- |
| ![2_Typing](./static/2_Typing.png) | ![3. AutoShift](./static/3_AutoShift.png) |

| 4. Keypad                           | 5. Symbol                           |
| ----------------------------------- | ----------------------------------- |
| ![4. Keypad](./static/4_Keypad.png) | ![5. Symbol](./static/5_Symbol.png) |
